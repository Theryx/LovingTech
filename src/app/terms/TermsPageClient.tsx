...
const ARTICLES = [
  ...
  {
    numFr: '5. Conditions produits',
    numEn: '5. Product conditions',
        ...
        <div className="space-y-8">
          {ARTICLES.map((a, i) => (
            <section key={i} className="border-t border-brand-grey/20 pt-6">
              ...
              <p className="text-sm text-brand-dark/70">{t({ en: a.en, fr: a.fr })}</p>
            </section>
          ))}
        </div>
