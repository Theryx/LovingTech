            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="pt-4">
                <button
                  ...
                  type="submit"
                  className="w-full bg-zinc-900 text-white dark:bg-white dark:text-black py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-zinc-700 dark:hover:bg-zinc-200 transition disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
