...
const SLIDES = [
  ...
  },
  {
    ...
    titleFr: 'Partout au Cameroun, via agences de bus.',
    titleEn: 'Anywhere in Cameroon, via bus agencies.',
    subtitleFr: '2 000 FCFA à Douala · 3 000 FCFA ailleurs · Gratuit dès 50 000 FCFA.',
    subtitleEn: '2,000 FCFA in Douala · 3,000 FCFA elsewhere · Free above 50,000 FCFA.',
    ctaHref: '/products',
